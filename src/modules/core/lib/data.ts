...
export const permissionGroups = {
    ...
    "Analíticas y Reportes": ["analytics:read", "analytics:purchase-suggestions:read", "analytics:production-report:read", "analytics:user-permissions:read", "analytics:transits-report:read", "analytics:physical-inventory-report:read"],
...
export const permissionTranslations: { [key: string]: string } = {
    ...
    "analytics:transits-report:read": "Analíticas: Reporte Tránsitos",
    "analytics:physical-inventory-report:read": "Analíticas: Reporte Inv. Físico",
