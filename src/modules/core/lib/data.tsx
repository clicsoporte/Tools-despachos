...
export const mainTools: Tool[] = [
  {
    ...
    icon: () => <Sheet className="h-6 w-6 text-white bg-emerald-600" />,
  },
  {
    id: "purchase-request",
    ...
    icon: () => <ShoppingCart className="h-6 w-6 text-white bg-amber-700" />,
  },
   {
    id: "planner",
    ...
    icon: () => <CalendarCheck className="h-6 w-6 text-white bg-purple-700" />,
  },
  {
    id: 'cost-assistant',
    ...
    icon: () => <Calculator className="h-6 w-6 text-white bg-orange-600" />,
  },
   {
    id: "warehouse",
    name: "Almacén",
    ...
    icon: () => <Warehouse className="h-6 w-6 text-white bg-cyan-600" />,
  },
     {
      id: "hacienda-query",
      ...
      icon: () => <Search className="h-6 w-6 text-white bg-blue-700" />,
    },
  {
    id: "help",
    ...
    href: "/dashboard/help",
    icon: () => <LifeBuoy className="h-6 w-6 text-white bg-orange-500" />,
  },
];
...
export const warehouseTools: Tool[] = [
    {
        ...
        icon: () => <Search className="h-6 w-6 text-white bg-cyan-600" />,
    },
    {
        ...
        icon: () => <QrCode className="h-6 w-6 text-white bg-sky-600" />,
    },
     {
        id: "assign-item",
        ...
        icon: () => <PackagePlus className="h-6 w-6 text-white bg-fuchsia-600" />,
    },
    {
        id: "inventory-count",
        ...
        icon: () => <ClipboardCheck className="h-6 w-6 text-white bg-lime-700" />,
    },
    {
        id: "warehouse-units",
        ...
        icon: () => <QrCode className="h-6 w-6 text-white bg-teal-600" />,
    },
    {
        ...
        icon: () => <Map className="h-6 w-6 text-white bg-indigo-500" />,
    }
];
...
export const adminTools: Tool[] = [
    {
        ...
        icon: () => <Users className="h-6 w-6 text-white bg-blue-500" />,
      },
      {
        id: "role-management",
        ...
        icon: () => <ShieldCheck className="h-6 w-6 text-white bg-green-500" />,
      },
      {
        id: "general-settings",
        ...
        icon: () => <Briefcase className="h-6 w-6 text-white bg-orange-500" />,
      },
      {
        id: "email-settings",
        ...
        icon: () => <Mail className="h-6 w-6 text-white bg-purple-600" />,
      },
      {
        ...
        icon: () => <MessageSquare className="h-6 w-6 text-white bg-green-600" />,
      },
      {
        id: "quoter-settings",
        ...
        icon: () => <BookMarked className="h-6 w-6 text-white bg-emerald-600" />,
      },
      {
      ...
      },
      {
        ...
        icon: () => <FileUp className="h-6 w-6 text-white bg-cyan-700" />,
      },
       {
        id: "maintenance",
        name: "Mantenimiento",
        ...
        icon: () => <ServerCog className="h-6 w-6 text-white bg-red-600" />,
      },
      {
        id: "api-settings",
        ...
        icon: () => <Network className="h-6 w-6 text-white bg-blue-700" />,
      },
       {
        id: "planner-settings",
        ...
        icon: () => <Factory className="h-6 w-6 text-white bg-purple-700" />,
      },
       {
        ...
        icon: () => <Store className="h-6 w-6 text-white bg-amber-700" />,
      },
      {
        ...
        icon: () => <Wrench className="h-6 w-6 text-white bg-fuchsia-600" />,
      },
      {
        id: "log-viewer",
        ...
        icon: () => <FileTerminal className="h-6 w-6 text-white bg-slate-600" />,
      }
];
...
export const analyticsTools: Tool[] = [
    {
        ...
        icon: () => <Lightbulb className="h-6 w-6 text-white bg-blue-600" />,
    },
    {
        id: "purchase-report",
        ...
        icon: () => <FileText className="h-6 w-6 text-white bg-cyan-600" />,
    },
     {
        id: "transits-report",
        ...
        icon: () => <Truck className="h-6 w-6 text-white bg-sky-600" />,
    },
    {
        ...
        icon: () => <BarChartBig className="h-6 w-6 text-white bg-indigo-500" />,
    },
    {
        ...
        icon: () => <ClipboardCheck className="h-6 w-6 text-white bg-lime-600" />,
    },
    {
        id: "user-permissions",
        ...
        icon: () => <UserCheck className="h-6 w-6 text-white bg-fuchsia-600" />,
    },
];
